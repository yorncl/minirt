...
test_wsl:
	$(CC) $(CFLAGS) $(SRCS) -g -fsanitize=address -I./headers -I./libft -o ./test/run_tests $(INCLUDES_WIN_WSL)
test_mac:
	$(CC) $(CFLAGS) $(SRCS) -g -fsanitize=address -I./headers -I./libft -o ./test/run_tests $(INCLUDES_MAC)
test_vec3:
